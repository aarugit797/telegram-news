...
WHAT: The RSS Newsletters source agent. Fetches TLDR AI, The Batch,
ByteByteGo, Simon Willison, Andrej Karpathy blog. Runs hybrid filter
(prompts/filters/rss_filter.py) which explicitly checks for
cross-source duplication against what's already in the News DB
before approving.

WHY: Owns exactly one data source end to end - independent schedule
(once daily, 9am), independent failure handling.
